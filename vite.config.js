...
export default defineConfig(({ mode }) => {
    ...
    return {
        plugins: [
            laravel({
                input: ['resources/css/app.css', 'resources/css/cardapio.css', 'resources/css/radape.css', 'resources/css/admin.css', 'resources/js/app.js', 'resources/js/cookieslocalizacao.js'],
                refresh: true,
            }),
            tailwindcss(),
        ],
